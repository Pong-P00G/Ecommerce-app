...
var capitalize2 = cacheStringFunction(function(str) {
...
function matchName(target, sourceName) {
  var camelized = camelize2(target);
  var capitalized = capitalize2(camelized);
  return !!sourceName && (sourceName === target || sourceName === camelized || sourceName === capitalized || capitalize2(camelize2(sourceName)) === capitalized);
}
...
function requireTokenizer$1() {
  ...
  Tokenizer2.prototype._read_pair = function(c, d) {
    var token2 = null;
    if (c === "#" && d === "{") {
...
var DEFAULT_STUBS = {
  ...
  transition: function(type) {
    return type === Transition || type === BaseTransition;
  },
  "transition-group": function(type) {
    return type === TransitionGroup;
  }
};
