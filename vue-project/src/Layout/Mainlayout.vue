...
import { useTheme } from '../composables/ThemeToggle.js';
    ...
    <div class="min-h-screen bg-gray-50 text-gray-900 dark:bg-gray-900 dark:text-gray-100">
        ...
        <header class="sticky top-0 z-10 border-b border-gray-200 bg-white/80 backdrop-blur dark:border-gray-700 dark:bg-gray-900/80">
            <div class="mx-auto flex h-14 max-w-7xl items-center justify-between px-4">
                ...
                <!-- Right Actions -->
                <div class="flex items-center gap-2">
                    <ThemeToggle @click="useTheme" class="bg-white"/>
                    <!-- Help Button -->
                    <button 
                        @click="showHelp = true"
        ...
        <div class="mx-auto grid max-w-9xl grid-cols-1 gap-6 px-4 py-6 md:grid-cols-[240px_1fr]">
            <!-- Sidebar -->
            <aside 
                class="fixed inset-y-20 left-4 right-4 z-30 rounded-xl border border-gray-200 bg-white p-3 shadow-lg 
                    md:static md:inset-auto md:z-0 md:h-[calc(100vh-6rem)] md:self-start 
                ...
                <nav class="flex flex-col gap-1">
                    <RouterLink
                        ...
                        :key="item.to"
                        :to="item.to"
                        class="rounded-md px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-gray-900 
                ...
                <!-- Tips box -->
                <div class="mt-4 rounded-lg bg-linear-to-br from-indigo-50 to-purple-50 p-3 text-xs text-gray-600 
                            dark:from-indigo-900/20 dark:to-purple-900/20 dark:text-gray-300">
