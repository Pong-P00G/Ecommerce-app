...
const nav = [
    ...
    { label: 'Stocks', to: '/dashboard/manage-stock' },
    { label: 'Users', to: '/dashboard/manage-user' },
    { label: 'Analytics', to: '/dashboard/analytic' },
    { label: 'Reports', to: '/dashboard/report' },
    { label: 'Add Product', to: '/dashboard/AddProduct' },
]
</script>
...
<template>
    <div class="min-h-screen bg-gray-50 text-gray-900 dark:bg-gray-900 dark:text-gray-100">
        ...
        <!-- Sidebar -->
        <aside
            class="fixed inset-y-20 left-4 right-4 z-30 rounded-xl border border-gray-200 bg-white p-3 shadow-lg md:static md:inset-auto md:z-0 md:h-[calc(100vh-6rem)] md:self-start dark:border-gray-700 dark:bg-gray-800"
        ...
        >
            ...
            <div class="mt-4 rounded-lg bg-gradient-to-br from-indigo-50 to-purple-50 p-3 text-xs text-gray-600 dark:from-indigo-900/20 dark:to-purple-900/20 dark:text-gray-300">
