        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex items-center justify-between mb-8">
                ...
                <button @click="openAddProduct"
                    class="px-6 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors font-semibold flex items-center gap-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-2xl shadow-sm p-6">
                    ...
                    <p class="text-gray-600 text-sm mb-1">Active Products</p>
                ...
                <div class="bg-white rounded-2xl shadow-sm p-6">
                    ...
                    <p class="text-gray-600 text-sm mb-1">Draft Products</p>
                    <p class="text-3xl font-bold text-gray-900">{{ draftProducts }}</p>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm p-6">
                    ...
                    <p class="text-gray-600 text-sm mb-1">Inactive Products</p>
                    <p class="text-3xl font-bold text-gray-900">{{ inactiveProducts }}</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm p-6 mb-6">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="md:col-span-2">
                        <div class="relative">
                            <input v-model="searchQuery" @keyup.enter="handleSearch" type="text"
                                ...
                                class="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 disabled:opacity-50" />
                    ...
                    <select v-model="filterCategory" @change="handleFilter" :disabled="loading"
                        class="px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 bg-white disabled:opacity-50">
            ...
            <!-- Loading State -->
            <div v-if="loading && products.length === 0" class="bg-white rounded-2xl shadow-sm p-12 text-center">
                <div
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <tr v-for="product in filteredProducts" :key="product.product_id"
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-500">{{ truncateText(product.description, 40) }}
                                            </p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <!-- Price -->
                                <td class="px-6 py-4">
                                    <span class="text-sm font-semibold text-gray-900">{{ formatPrice(product.base_price)
                                        }}</span>
                                </td>
                                ...
                                <!-- Created -->
                                <td class="px-6 py-4">
                                    <span class="text-sm text-gray-600">{{ formatDate(product.created_at) }}</span>
                                </td>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-2">
                            <button @click="prevPage" :disabled="currentPage === 1"
                                class="px-4 py-2 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                                Previous
                            </button>
                            <div class="flex items-center gap-1">
                                <button v-for="page in totalPages" :key="page" @click="goToPage(page)"
                                    :class="page === currentPage ? 'bg-gray-900 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'"
