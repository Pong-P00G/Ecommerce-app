    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="flex items-center justify-between mb-8">
        <div>
          ...
          <p class="text-gray-600 mt-1">Manage customer and admin accounts</p>
        </div>
      ...
      <!-- Loading State -->
      <div v-if="loading && users.length === 0" class="bg-white rounded-2xl shadow-sm p-12 text-center">
          ...
          <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-200">
              <tr v-for="user in filteredUsers" :key="user.id" class="hover:bg-gray-50 transition-colors">
                ...
                <!-- Orders -->
                <td class="px-6 py-4">
                  <span class="text-sm font-semibold text-gray-900">{{ user.orders }}</span>
                </td>

                <!-- Joined -->
                <td class="px-6 py-4">
                  <span class="text-sm text-gray-600">{{ formatDate(user.created) }}</span>
                </td>
        ...
        <form @submit.prevent="saveUser" class="space-y-4">
          ...
          <div class="flex gap-3 pt-4">
            ...
            <button type="submit" :disabled="loading"
              class="flex-1 px-6 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors font-semibold disabled:opacity-50">
