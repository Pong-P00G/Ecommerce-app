...
onMounted(async () => {
  try {
    ...
    productCard.value = Hoodie.map(Hoodie => ({
      ...Hoodie,
      image: Hoodie.image, 
      price: parseFloat(Hoodie.price.replace('$', '')), 
      originalPrice: parseFloat(Hoodie.price.replace('$', '')) * 1.3,
...
const addToCart = async (Hoodie) => {
  try {
    ...
    const cartItem = {
      ...
      quantity: qty,
      price: Hoodie.price,
      originalPrice: Hoodie.originalPrice,
    ...
    if (existingIndex !== -1) {
      ...
      showToast(`${Hoodie.name} added to cart! 🛒`, 'success');
    }
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
          <div class="text-center">
            ...
            <h1 class="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4">
              Premium T-Hoodie Collection
            </h1>
            <p class="text-lg sm:text-xl lg:text-2xl text-blue-100 max-w-3xl mx-auto mb-8">
              Discover our curated selection of high-quality, comfortable t-Hoodies designed for the modern lifestyle.
            </p>
