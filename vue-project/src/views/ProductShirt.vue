...
onMounted(async () => {
  try {
    ...
    productCard.value = Shirt.map(Shirt => ({
      ...Shirt,
      image: Shirt.image, 
      price: parseFloat(Shirt.price.replace('$', '')), 
      originalPrice: parseFloat(Shirt.price.replace('$', '')) * 1.3,
...
const addToCart = async (Shirt) => {
  try {
    ...
    if (existingIndex !== -1) {
      ...
      showToast(`${Shirt.name} added to cart! 🛒`, 'success');
    }
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
          <div class="text-center">
            ...
            <p class="text-lg sm:text-xl lg:text-2xl text-blue-100 max-w-3xl mx-auto mb-8">
              Discover our curated selection of high-quality, comfortable t-Shirts designed for the modern lifestyle.
            </p>
